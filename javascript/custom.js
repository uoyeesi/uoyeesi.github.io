(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        function init() {
            var mapOptions = {
                zoom: 17,
                center: new google.maps.LatLng(42.308653, -71.11489),
...
particlesJS.load('particles-js', 'javascript/assets/particles.json', function() {
...
// Create a map object and specify the DOM element for display.
    var map = new google.maps.Map(document.getElementById('myMap'), {
      center: {lat: 42.308653, lng: -71.114893},
      zoom: 15,
      styles: [
    ...
    // Create a marker and set its position.
        var marker = new google.maps.Marker({
          map: map,
          position: {lat: 42.308653, lng: -71.1148932},
